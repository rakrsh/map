...
- [ ] `refactor` (code restructuring with no functionality changes)
- [ ] `docs` (documentation updates)
- [ ] `ci/cd` (changes to build process, CI pipelines, or workflow automation)
...
- [ ] Tested locally in environment: `[e.g., Docker / Local Host]`
